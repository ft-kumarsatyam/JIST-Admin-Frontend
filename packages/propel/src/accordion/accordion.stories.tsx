    ...
    return (
      <Accordion.Root className="w-96">
        <Accordion.Item value="item-1">
          <Accordion.Trigger>What is JIST?</Accordion.Trigger>
          <Accordion.Content>
            JIST is an open-source project management tool designed for developers and teams to plan, track, and manage
        ...
        <Accordion.Item value="item-3">
          ...
          <Accordion.Content>
            JIST offers both free and paid plans. The free plan includes essential features for small teams, while paid
