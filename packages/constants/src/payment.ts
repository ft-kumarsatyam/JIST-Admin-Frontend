...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "JIST Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for JIST Cloud",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = "https://www.khelo.tech/";
