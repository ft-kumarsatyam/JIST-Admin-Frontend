...
export const ADMIN_BASE_PATH = process.env.VITE_ADMIN_BASE_PATH || "/admin";
...
// plane website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://www.khelo.tech";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "hello@khelo.tech";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://www.khelo.tech/";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://www.khelo.tech/";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://www.khelo.tech/";

/** Legal pages for auth footers and settings */
export const TERMS_OF_SERVICE_URL = process.env.VITE_TERMS_OF_SERVICE_URL || "https://www.khelo.tech/";
export const PRIVACY_POLICY_URL = process.env.VITE_PRIVACY_POLICY_URL || "https://www.khelo.tech/";
