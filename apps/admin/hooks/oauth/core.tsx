...
export const getCoreAuthenticationModesMap: (
  ...
  "unique-codes": {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for JIST using codes sent via email. You need to have set up SMTP to use this method.",
  ...
  google: {
    key: "google",
    name: "Google",
    description: "Allow members to log in or sign up for JIST with their Google accounts.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for JIST with their GitHub accounts.",
    icon: (
      <img
  ...
  gitlab: {
    key: "gitlab",
    name: "GitLab",
    description: "Allow members to log in or sign up to Jist with their GitLab accounts.",
  ...
  gitea: {
    key: "gitea",
    name: "Gitea",
    description: "Allow members to log in or sign up to Jist with their Gitea accounts.",
