      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-14">
          <div className="flex grow items-center gap-4">
            ...
            <div className="grow">
              <div className="text-13 leading-5 font-medium text-primary">Let JIST collect anonymous usage data</div>
              <div className="text-11 leading-5 font-regular text-tertiary">
                No PII is collected.This anonymized data is used to understand how you use JIST and build new features
                in line with{" "}
                <a
