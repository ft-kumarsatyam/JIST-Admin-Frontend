  ...
  return (
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[26rem] flex-col gap-6 rounded-2xl border border-[#E8DFF8] bg-white px-6 py-8 text-[#1A102B] shadow-[0_18px_50px_-28px_rgba(63,34,113,0.35)] sm:px-8">
          <FormHeader
            heading="Manage your JIST instance"
          ...
          >
            ...
            <p className="text-center text-[13px] font-medium text-[#5B4B72]">
              ...
              <Link href="/sign-up/" className="font-semibold text-[#6532B8] hover:text-[#3F2271] hover:underline">
                Create one
              </Link>
            </p>
          </form>
