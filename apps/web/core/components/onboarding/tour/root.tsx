...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the building block of JIST. Most concepts in JIST are either associated with work items and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
        ...
        <div className="w-4/5 overflow-hidden rounded-[10px] bg-surface-1 md:w-1/2 lg:w-2/5">
          <div className="h-full overflow-hidden">
            <div className="grid h-64 place-items-center bg-accent-primary">
              <PlaneLockup className="h-12 w-auto text-on-color" />
            </div>
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to JIST, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re glad that you decided to try out JIST. You can now manage your projects with ease. Get started
