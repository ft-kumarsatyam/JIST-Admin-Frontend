...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: FileText,
      action: () => {
        window.open("https://www.khelo.tech/", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    ...
    },
    {
      ...
      icon: GithubIcon,
      action: () => {
        window.open("https://github.com/ft-kumarsatyam/khelo-tech-PMM/issues/new", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
