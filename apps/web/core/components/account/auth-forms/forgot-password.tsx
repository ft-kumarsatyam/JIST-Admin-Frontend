    ...
    <FormContainer>
      ...
      <form onSubmit={handleSubmit(handleForgotPassword)} className="space-y-4">
        <div className="space-y-1">
          ...
          <Controller
            ...
            render={({ field: { value, onChange, ref } }) => (
              <Input
                ...
                className="h-10 w-full border border-[#D6C8EC] !bg-white pr-12 text-[#1A102B] placeholder:text-[#7A6B94]"
                autoComplete="off"
          ...
          />
          {resendTimerCode > 0 && (
            <p className="flex w-full items-start gap-1 px-1 text-11 font-medium text-[#067647]">
