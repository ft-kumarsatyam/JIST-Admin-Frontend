...
export function AuthUniqueCodeForm(props: TAuthUniqueCodeForm) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <label htmlFor="unique-code" className="text-13 font-medium text-[#3F2271]">
        ...
        <div className="flex w-full items-center justify-between px-1 pt-1 text-11">
          <p className="flex items-center gap-1 font-medium text-[#067647]">
          ...
          <button
            ...
            className={isRequestNewCodeDisabled ? "text-[#7A6B94]" : "font-medium text-[#6532B8] hover:text-[#3F2271]"}
