...
export const AppRailRoot = observer(() => {
  ...
  return (
    <div
      className="z-[26] h-full flex-shrink-0 bg-transparent transition-all duration-300 ease-in-out"
      style={{
        width: railWidth,
        display: "block",
      }}
    >
      <ContextMenu>
        <ContextMenu.Trigger className="h-full">
          <div className="flex h-full flex-col justify-between gap-4 px-1.5 py-3.5">
            <div
            ...
            >
              ...
              <div className="mx-2 border-t border-[#E4D9F5]" />
              <AppSidebarItem
                item={{
                  label: "Settings",
