...
import { ProjectBitbucketCommitsPanel } from "@/components/project/bitbucket-commits-panel";
    ...
    <SettingsContentWrapper header={<GeneralProjectSettingsHeader />}>
      ...
      <div className={`w-full ${isAdmin ? "" : "opacity-60"}`}>
        ...
        <div className="mt-8 space-y-3">
          <h3 className="text-14 font-semibold text-primary">Bitbucket commits</h3>
          <ProjectBitbucketCommitsPanel workspaceSlug={workspaceSlug} projectId={projectId} />
        </div>
