...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "JIST" },
  {
    name: "keywords",
    content: "JIST, sports management, athletes, events, tournaments, projects, collaboration",
  },
  ...
  { name: "twitter:image:alt", content: "JIST" },
];
